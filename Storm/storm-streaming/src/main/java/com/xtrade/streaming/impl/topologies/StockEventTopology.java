...
public abstract class StockEventTopology {
  private static final Logger LOG = Logger.getLogger(StockEventTopology.class);
  protected Properties topologyConfig;

  public StockEventTopology(String configFileLocation) throws Exception {
